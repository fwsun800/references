...
jQuery(document).ready(function(){
    jQuery('.new-pubmed-banner-ad').bind('click', tryNewPubMedClick);
});

function tryNewPubMedClick(e){ 
	e.stopPropagation();
	e.preventDefault();
		
	tryNewPubMedSetCookie();
...
function tryNewPubMedSetCookie(){
    var d = new Date();
    d.setTime(d.getTime() + (365*24*60*60*1000));
    var expires = "expires="+d.toUTCString();
    
    var newCookie = "use_new_pubmed=true;domain=.ncbi.nlm.nih.gov;path=/;" + expires;
